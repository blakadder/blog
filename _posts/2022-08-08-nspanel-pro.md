...
![Front](/assets/images/nspanel_pro/front.jpg)
...
![Back](/assets/images/nspanel_pro/back.jpg)
...
![Base differences](/assets/images/nspanel_pro/base.jpg)
...
![PCB](/assets/images/nspanel_pro/pcb.jpg)
...
Turning on the screen I'm greeted by the boot animation and a very lenghty one at that. Boots a lot slower than the old NSPanel. Screen looks a lot birighter and viewing angles better than the original. There's an improvement.
...
![GUI](/assets/images/nspanel_pro/firstboot.jpg)

After connecting Wi-Fi, pair the panel with the eWeLink app using the displayed QR code.

![Initial Screen](/assets/images/nspanel_pro/initialscreen.jpg)
...
![Devices](/assets/images/nspanel_pro/devices.jpg)
...
![Settings](/assets/images/nspanel_pro/settings.jpg)
...
![eWeLink Camera app](/assets/images/nspanel_pro/ewelinkcamera.jpg)
...
![Scenes](/assets/images/nspanel_pro/scenes.jpg)
