...
There's even a possibility to flash the Zigbee module with router firmware that's yet to be explored. For now it is possible to bridge the Zigbee module to TCP for use with Zigbee2MQTT or ZHA.
