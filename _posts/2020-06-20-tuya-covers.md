...
Many previously discovered functions are listed in [dpID Function Tables](https://tasmota.github.io/docs/TuyaMCU/#dpid-function-tables)

### Tuya Website
If you don't want to play, you can cheat a bit. Register for an account at https://iot.tuya.com where you can build your own Tuya device. During the bild process it can show you default dpId's used for all functions available for that device type. After creating my own Curtain Motor I could confirm all of the findings.
