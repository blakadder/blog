...
```shellsession
2022/10/12 19:01:56 Elelabs_EzspFwUtility:   EZSP adapter in bootloader mode detected:
2022/10/12 19:01:56 Elelabs_EzspFwUtility:   Gecko Bootloader v1.8.0
2022/10/12 19:01:56 Elelabs_EzspFwUtility:   Allready in bootloader mode. No need to restart
...
The underlying launcher is more persistent and we need to hide the .apk from the system by renaming it.
