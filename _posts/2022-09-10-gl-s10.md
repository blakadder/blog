...
***WARNING*** On 2022-09-19 I've received a report that a new hardware revision marked [GL-S10-V2.1](https://github.com/esphome/bluetooth-proxies/issues/19) uses a currently unsupported Ethernet chip and therefore I suggest to avoid buying the new stock until a driver is developed.
