...
***WARNING*** There's a new hardware revision marked [GL-S10-V2.1](https://github.com/esphome/bluetooth-proxies/issues/19) with a new Ethernet chip. This tutorial uses the v1.0 version but applies to all revisions, only the ESPHome configuration is different.
