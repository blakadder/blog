...
Configuration file was made to mimic the original functions as close as possible. That means the Power LED will always be on and Bluetooth LED blinks when receiving BLE packets. Network LED serves as a [status LED](https://esphome.io/components/status_led.html).
